(define (problem viatge-ext3-2)

  ;; -------------------------------------------------------------------
  ;; Joc de prova 2 (ext.3): el PREU MÍNIM és restrictiu.
  ;; Mateix mapa que el problema 1 però amb rang 380..600. El pla més
  ;; barat possible (uns 310) queda PER SOTA del mínim, de manera que el
  ;; planificador està obligat a encarir el viatge (vol/hotel més cars,
  ;; o més ciutats) fins a entrar dins el rang [380, 600].
  ;; Demostra l'efecte del límit inferior de preu.
  ;; -------------------------------------------------------------------
